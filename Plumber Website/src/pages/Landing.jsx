...
const HERO_METRICS = [
  ...
  ['8:00-22:00', 'график работы'],
  ['98%', 'закрытие за визит'],
];

const LIVE_FEED = [
  { code: 'KZ-14', district: 'Бостандыкский район', service: 'Аварийный выезд', eta: '14 мин', load: 78, status: 'В пути', tone: 'moving' },
  { code: 'KZ-08', district: 'Алмалинский район', service: 'Монтаж и установка', eta: '21 мин', load: 61, status: 'Готов', tone: 'ready' },
  { code: 'KZ-21', district: 'Ауэзовский район', service: 'Засоры и канализация', eta: '19 мин', load: 84, status: 'На заказе', tone: 'busy' },
  { code: 'KZ-05', district: 'Медеуский район', service: 'Трубы и бойлеры', eta: '27 мин', load: 52, status: 'Свободен', tone: 'ready' },
];
...
const REVIEWS = [
  {
    ...
    text: 'Мастер приехал очень быстро, как и обещали. Прорвало трубу, все устранили за полчаса. Очень благодарен за оперативность!',
  },
  {
    name: 'Светлана К.',
    role: 'Установка сантехники',
    text: 'Заказывала установку новой ванны и унитаза. Сделали все аккуратно, мусор за собой убрали. Цена осталась такой же, как договаривались.',
  },
  {
    name: 'Дмитрий П.',
    role: 'Прочистка засора',
    text: 'Отличный сервис. Не мог пробить засор на кухне никакими средствами. Сантехник приехал с профессиональным тросом и решил проблему за 15 минут.',
  },
];
    ...
    <div ref={shellRef} className="lp future-lp">
          ...
          <div className="future-shell future-hero__grid">
            <div className="future-hero__content">
              ...
              <h1 className="fu">
                Услуги сантехников
                <br />
                <span>быстро, качественно, с гарантией</span>
              </h1>

              <p className="fu">
                Выполняем полный спектр сантехнических работ в Алмате. От устранения протечек и прочистки труб до сложного монтажа систем отопления и водоснабжения. Опытные мастера и прозрачные цены.
              </p>
            ...
            <div className="future-hero__scene fu">
              <article className="glass-panel future-scene future-scene--mission">
                ...
                <div className="future-mission__head">
                  <div>
                    ...
                    <span>Алмата · Центр · квартира 37</span>
                  </div>
              ...
              <article className="glass-panel future-scene future-scene--pulse">
                ...
                <div className="future-pulse-grid">
                  {['Алмалинский', 'Медеуский', 'Бостандыкский', 'Ауэзовский', 'Турксибский', 'Жетысуский', 'Алатауский', 'Наурызбайский'].map((item, index) => (
                    <div key={item} className="future-pulse-grid__item">
                      <span className={`future-pulse-grid__node future-pulse-grid__node--${(index % 4) + 1}`} />
                      <strong>{item}</strong>
        ...
        <section id="services" className="future-section">
          <div className="future-shell">
            <div className="future-section__head fu">
              ...
              <h2>Широкий спектр сантехнических работ</h2>
              <p>
                Мы предлагаем качественное выполнение любых сантехнических задач. Выберите нужную услугу, чтобы узнать ориентировочную стоимость и время прибытия мастера.
              </p>
            </div>
        ...
        <section id="audience" className="future-section future-section--audience">
          <div className="future-shell">
            <div className="future-section__head fu">
              ...
              <h2>Сантехнические работы для квартир, домов и бизнеса в Алмате</h2>
              <p>
        ...
        <section id="dispatch" className="future-section future-section--deep">
          <div className="future-shell future-dispatch">
            <div className="future-dispatch__copy">
              ...
              <h2 className="fu">Быстрое реагирование на вашу заявку</h2>
              <p className="fu">
                Наши мастера дежурят во всех районах Алматы. Мы ценим ваше время, поэтому
                оперативно выезжаем на вызовы, чтобы решить проблемы с сантехникой в кратчайшие сроки.
              </p>

              <div className="future-value-list fu">
                {[
                  'Быстрый приезд мастера благодаря дежурным бригадам по городу.',
                  'Ориентировочное время прибытия и стоимость известны заранее.',
                  'Используем профессиональный инструмент и качественные материалы.',
              ...
              <article className="glass-panel future-presence fu">
                ...
                <div className="future-presence__canvas">
                  ...
                  <div className="future-presence__overlay">
                    ...
                    <span>Алмалинский, Бостандыкский, Ауэзовский</span>
                  </div>
                </div>
              </article>
        ...
        <section id="reviews" className="future-section">
          <div className="future-shell">
            <div className="future-section__head fu">
              ...
              <h2>Нам доверяют ремонт своей сантехники</h2>
              <p>
                Мы гордимся качеством нашей работы. Ознакомьтесь с отзывами людей,
          ...
          <div className="future-shell future-contact">
            <article className="glass-panel future-cta fu">
              ...
              <p>
                ...
                по Алмате и примерную стоимость работ.
              </p>
              ...
              <div className="future-cta__meta">
                ...
                <span>Выезд с 8:00 до 22:00</span>
              </div>
            </article>
              ...
              <article className="glass-panel future-contact-card fu">
                ...
                <div className="future-contact-flow">
                  {[
                    ...
                    ['03', 'После подтверждения согласуем время выезда по Алмате.'],
                  ].map(([num, text]) => (
              ...
              <article className="glass-panel future-contact-card fu">
                ...
                <div className="future-contact-links">
                  ...
                  <div>
                    ...
                    <span>Алмата и ближайший пригород</span>
                  </div>
                  <div>
                    <strong>Ответ</strong>
      ...
      <footer className="future-footer">
        <div className="future-shell future-footer__inner">
          ...
          <p>© 2026 Сантех строй. Качественные сантехнические услуги в Алмате с гарантией.</p>
