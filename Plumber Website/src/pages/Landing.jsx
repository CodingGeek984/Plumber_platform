    ...
    <div ref={shellRef} className="lp future-lp">
        ...
        <section id="hero" className="future-hero">
          <div className="future-shell future-hero__grid">
            <div className="future-hero__content">
              ...
              <p className="fu">
                Выполняем полный спектр сантехнических работ в Алматы. От устранения протечек и прочистки труб до сложного монтажа систем отопления и водоснабжения. Опытные мастера и прозрачные цены.
              </p>
      ...
      <footer className="future-footer">
        <div className="future-shell future-footer__inner">
          ...
          <p>© 2026 Сантех строй. Качественные сантехнические услуги в Алматы с гарантией.</p>
